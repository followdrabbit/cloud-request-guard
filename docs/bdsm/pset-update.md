# BDSM - Alteracao de PSET (`pset-update`)

- Categoria: PSET AWS
- Fonte funcional: [ADR_ALTERACAO_PSET_AWS.md](../adr/ADR_ALTERACAO_PSET_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `pset-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Nome do PSET; Acoes da Alteracao do PSET; Justificativa |
...
| Gate 4 - Execucao | Executar alteracao controlada com validacao de impacto | Selecionar ao menos uma acao: Adicionar policy, Remover policy, Adicionar conta ou Remover conta.; Cada acao deve conter ao menos um item objetivo para execucao.; Limite de ate 10 itens por acao. |
