# BDSM - Alteracao de usuario IAM (`iam-user-update`)

- Categoria: Usuarios IAM AWS
- Fonte funcional: [ADR_ALTERACAO_USUARIO_IAM_AWS.md](../adr/ADR_ALTERACAO_USUARIO_IAM_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `iam-user-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Usuario IAM Alvo (nome/ARN); Acoes da Alteracao do Usuario IAM; Justificativa |
