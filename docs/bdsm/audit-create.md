# BDSM - Abertura de auditoria (`audit-create`)

- Categoria: Auditoria AWS
- Fonte funcional: [ADR_ABERTURA_AUDITORIA_AWS.md](../adr/ADR_ABERTURA_AUDITORIA_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `audit-create` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Escopo da Auditoria; Periodo de Referencia; Justificativa |
...
| Gate 4 - Execucao | Executar coleta de evidencias e analise de auditoria | Definir escopo inicial claro para reduzir retrabalho. |
