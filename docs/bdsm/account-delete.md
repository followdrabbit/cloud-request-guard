# BDSM - Remocao de conta AWS (`account-delete`)

- Categoria: Contas AWS
- Fonte funcional: [ADR_REMOCAO_CONTA_AWS.md](../adr/ADR_REMOCAO_CONTA_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `account-delete` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Plano de Descomissionamento; Justificativa |
...
| Gate 4 - Execucao | Executar remocao/revogacao controlada e validar dependencias | Plano deve cobrir migracao, logs e encerramento financeiro. |
