# BDSM - Remocao de PSET (`pset-delete`)

- Categoria: PSET AWS
- Fonte funcional: [ADR_REMOCAO_PSET_AWS.md](../adr/ADR_REMOCAO_PSET_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `pset-delete` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Nome do PSET; Justificativa |
...
| Gate 4 - Execucao | Executar remocao/revogacao controlada e validar dependencias | Validar impacto em grupos e contas antes de remover. |
