# BDSM - Criacao de conta AWS (`account-create`)

- Categoria: Contas AWS
- Fonte funcional: [ADR_CRIACAO_CONTA_AWS.md](../adr/ADR_CRIACAO_CONTA_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `account-create` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Nome da conta AWS; Descricao / finalidade da conta; Tipo de conta; Ambiente; Responsavel de negocio; E-mail do responsavel principal; Responsavel tecnico; Gestor aprovador; Centro de custo; Unidade de negocio; Justificativa da criacao |
...
| Gate 4 - Execucao | Executar criacao conforme padrao, menor privilegio e rastreabilidade | Nome segue AWS_AC_{NOME_DA_CONTA}_{PRD|HML|DEV}. |
