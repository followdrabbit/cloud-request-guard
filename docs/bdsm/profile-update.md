# BDSM - Alteracao de perfil corporativo (`profile-update`)
...
Definir o fluxo proposto de execucao do chamado `profile-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Perfil Corporativo Alvo; Grupo do Perfil de Acesso (nome livre); PSET Associado (nome/ARN); Justificativa |
...
| Gate 4 - Execucao | Executar alteracao controlada com validacao de impacto | Preservar segregacao de funcao e menor privilegio. |
