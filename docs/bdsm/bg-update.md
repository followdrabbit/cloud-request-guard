# BDSM - Alteracao de acesso emergencial (`bg-update`)
...
Definir o fluxo proposto de execucao do chamado `bg-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
flowchart TD
  ...
  F --> G[Ajustar acesso emergencial mantendo escopo minimo necessario]
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Ticket BG em Andamento; Nova Duracao Maxima; Justificativa Emergencial |
...
| Gate 4 - Execucao | Ajustar acesso emergencial mantendo escopo minimo necessario | Manter vinculo com incidente original. |
