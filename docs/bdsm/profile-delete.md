# BDSM - Remocao de perfil corporativo (`profile-delete`)

- Categoria: Acessos Corporativos (AD + Identity Center)
- Fonte funcional: [ADR_REMOCAO_PERFIL_ACESSO_AWS.md](../adr/ADR_REMOCAO_PERFIL_ACESSO_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `profile-delete` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Perfil Corporativo Alvo; Plano de Revogacao e Migracao; Justificativa |
...
| Gate 4 - Execucao | Executar remocao/revogacao controlada e validar dependencias | Detalhar destino dos usuarios impactados. |
