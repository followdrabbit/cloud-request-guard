# BDSM - Encerramento de auditoria (`audit-close`)

- Categoria: Auditoria AWS
- Fonte funcional: [ADR_ENCERRAMENTO_AUDITORIA_AWS.md](../adr/ADR_ENCERRAMENTO_AUDITORIA_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `audit-close` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; ID da Auditoria; Parecer Final; Justificativa |
...
| Gate 4 - Execucao | Executar coleta de evidencias e analise de auditoria | Encerrar apenas com evidencias e parecer consolidado. |
