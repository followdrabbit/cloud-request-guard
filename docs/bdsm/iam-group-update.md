# BDSM - Alteracao de grupo IAM (`iam-group-update`)

- Categoria: Grupos IAM AWS
- Fonte funcional: [ADR_ALTERACAO_GRUPO_IAM_AWS.md](../adr/ADR_ALTERACAO_GRUPO_IAM_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `iam-group-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; Grupo IAM Alvo (nome/ARN); Acoes da Alteracao do Grupo IAM; Justificativa |
...
| Gate 4 - Execucao | Executar alteracao controlada com validacao de impacto | Selecionar ao menos uma acao: Adicionar policy, Remover policy, Adicionar usuario ou Remover usuario.; Cada acao deve conter ao menos um item objetivo para execucao.; Limite de ate 10 itens por acao. |
