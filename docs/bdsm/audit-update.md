# BDSM - Alteracao de auditoria (`audit-update`)

- Categoria: Auditoria AWS
- Fonte funcional: [ADR_ALTERACAO_AUDITORIA_AWS.md](../adr/ADR_ALTERACAO_AUDITORIA_AWS.md)

## 1. Objetivo do processo
Definir o fluxo proposto de execucao do chamado `audit-update` com controles de qualidade, governanca, seguranca e rastreabilidade.
...
flowchart TD
  ...
  F --> G[Executar coleta de evidencias e analise de auditoria]
...
| --- | --- | --- |
| Gate 1 - Intake | Campos obrigatorios preenchidos | Conta AWS; ID da Auditoria; Ajustes de Escopo/Prazo; Justificativa |
| Gate 2 - Qualidade | Validacoes obrigatorias satisfeitas | Escopo obrigatorio; Justificativa obrigatoria; Conta AWS obrigatoria |
| Gate 3 - Governanca | Aprovacoes registradas | Gestor solicitante; Cloud Audit Specialist; Seguranca Cloud |
| Gate 4 - Execucao | Executar coleta de evidencias e analise de auditoria | Registrar motivacao da mudanca e aprovacao correspondente. |
...
- Registrar motivacao da mudanca e aprovacao correspondente.
