...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: bg-update
- Categoria: Breaking Glass AWS
- Acao registrada: Alteracao de acesso emergencial
...
Foco deste ADR: somente a tela de **Alteracao de acesso emergencial**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Alteracao de acesso emergencial".
...
**Explicacao**: Manter vinculo com incidente original.
**Exemplo**: Ticket AWS-BG-95001 prorrogado por 1 hora

## 3. Campos da Tela (Alteracao de acesso emergencial)
**Objetivo da tela**: Ajustar duracao de acesso emergencial em andamento.
...
- **Nova Duracao Maxima**: Campo tecnico/operacional necessario para execucao segura.
...
## 7. Exemplos da Tela
- Ticket AWS-BG-95001 prorrogado por 1 hora
