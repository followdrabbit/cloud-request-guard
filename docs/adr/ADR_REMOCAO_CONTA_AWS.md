...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: account-delete
- Categoria: Contas AWS
- Acao registrada: Remocao de conta AWS
...
Foco deste ADR: somente a tela de **Remocao de conta AWS**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Remocao de conta AWS".
...
**Explicacao**: Plano deve cobrir migracao, logs e encerramento financeiro.
**Exemplo**: Migrar workloads e manter logs por 12 meses

## 3. Campos da Tela (Remocao de conta AWS)
**Objetivo da tela**: Descomissionar conta com controle de risco.
...
- **Plano de Descomissionamento**: Plano de execucao controlada e, quando aplicavel, reversao.
...
- Plano deve cobrir migracao, logs e encerramento financeiro.

## 7. Exemplos da Tela
- Migrar workloads e manter logs por 12 meses
...
- **Plano de Descomissionamento**
  Tooltip: Descreva ordem de desativacao, migracao de workloads, logs e encerramento financeiro.
  Exemplo: Migrar workloads, manter logs por 12 meses e encerrar billing.
