...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: profile-delete
- Categoria: Acessos Corporativos (AD + Identity Center)
- Acao registrada: Remocao de perfil corporativo
...
Foco deste ADR: somente a tela de **Remocao de perfil corporativo**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Remocao de perfil corporativo".
...
**Explicacao**: Detalhar destino dos usuarios impactados.
**Exemplo**: Migracao para perfil readonly de contingencia

## 3. Campos da Tela (Remocao de perfil corporativo)
**Objetivo da tela**: Desativar perfil com plano de migracao de acessos.
### 3.1 Campos obrigatorios
- Conta AWS
- Perfil Corporativo Alvo
- Plano de Revogacao e Migracao
- Justificativa
...
- **Plano de Revogacao e Migracao**: Plano de execucao controlada e, quando aplicavel, reversao.
...
- Detalhar destino dos usuarios impactados.

## 7. Exemplos da Tela
- Migracao para perfil readonly de contingencia
