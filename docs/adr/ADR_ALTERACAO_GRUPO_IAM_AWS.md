...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: iam-group-update
- Categoria: Grupos IAM AWS
- Acao registrada: Alteracao de grupo IAM
...
Foco deste ADR: somente a tela de **Alteracao de grupo IAM**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Alteracao de grupo IAM".
...
**Explicacao**: Selecionar ao menos uma acao: Adicionar policy, Remover policy, Adicionar usuario ou Remover usuario. Cada acao deve conter ao menos um item objetivo para execucao. Limite de ate 10 itens por acao.
**Exemplo**: Adicionar policy SecurityAudit + Remover usuario legado sem uso

## 3. Campos da Tela (Alteracao de grupo IAM)
**Objetivo da tela**: Ajustar grupo IAM existente com acoes explicitas de policy e membership.
...
- **Grupo IAM Alvo (nome/ARN)**: Identificador livre do recurso existente (nome legado ou ARN), sem exigir taxonomia nova.
- **Acoes da Alteracao do Grupo IAM**: Campo tecnico/operacional necessario para execucao segura.
...
## 7. Exemplos da Tela
- Adicionar policy SecurityAudit + Remover usuario legado sem uso
...
- **Grupo IAM Alvo (nome/ARN)**
  Tooltip: Informe nome ou ARN do grupo IAM existente para alteracao/remocao.
  Exemplo: arn:aws:iam::123456789012:group/grupo-legado
  Documentacao AWS: [IAM User groups](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_groups.html)

- **Acoes da Alteracao do Grupo IAM**
  Tooltip: Selecione ao menos uma acao de alteracao para o grupo IAM e detalhe os itens envolvidos.
  Exemplo: Adicionar policy + Remover usuario
  Documentacao AWS: [IAM User groups](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_groups.html), [IAM Policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html), [IAM Users](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users.html)
