...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: role-delete
- Categoria: Role AWS
- Acao registrada: Remocao de role
...
Foco deste ADR: somente a tela de **Remocao de role**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Remocao de role".
...
**Explicacao**: Informar role em nome livre ou ARN. Validar dependencias e rollback antes da remocao.
**Exemplo**: role-legada-pipeline ou arn:aws:iam::123456789012:role/role-legada-pipeline

## 3. Campos da Tela (Remocao de role)
**Objetivo da tela**: Remover role existente no ambiente da conta selecionada.
...
- **Role alvo para remocao**: Nome livre ou ARN da role existente que sera removida.
...
## 7. Exemplos da Tela
- role-legada-pipeline ou arn:aws:iam::123456789012:role/role-legada-pipeline
