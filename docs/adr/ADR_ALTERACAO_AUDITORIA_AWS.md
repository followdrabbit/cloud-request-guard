...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: audit-update
- Categoria: Auditoria AWS
- Acao registrada: Alteracao de auditoria
...
Foco deste ADR: somente a tela de **Alteracao de auditoria**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Alteracao de auditoria".
...
**Explicacao**: Registrar motivacao da mudanca e aprovacao correspondente.
**Exemplo**: Incluir revisao de SCP e estender prazo em 3 dias

## 3. Campos da Tela (Alteracao de auditoria)
**Objetivo da tela**: Ajustar escopo e prazo de auditoria em andamento.
...
- **Ajustes de Escopo/Prazo**: Campo tecnico/operacional necessario para execucao segura.
...
## 7. Exemplos da Tela
- Incluir revisao de SCP e estender prazo em 3 dias
