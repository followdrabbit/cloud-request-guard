...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: iam-group-delete
- Categoria: Grupos IAM AWS
- Acao registrada: Remocao de grupo IAM
...
Foco deste ADR: somente a tela de **Remocao de grupo IAM**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Remocao de grupo IAM".
...
**Explicacao**: Plano de migracao deve cobrir como os membros serao realocados antes da remocao.
**Exemplo**: Migrar usuarios para IAM-Backup-Operators antes de remover

## 3. Campos da Tela (Remocao de grupo IAM)
**Objetivo da tela**: Remover grupo com plano de migracao dos membros.
...
- **Plano de Migracao dos Membros**: Plano de execucao controlada e, quando aplicavel, reversao.
...
## 7. Exemplos da Tela
- Migrar usuarios para IAM-Backup-Operators antes de remover
