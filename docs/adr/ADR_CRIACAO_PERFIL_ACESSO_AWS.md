...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: profile-create
- Categoria: Acessos Corporativos (AD + Identity Center)
- Acao registrada: Criacao de perfil corporativo
...
Foco deste ADR: somente a tela de **Criacao de perfil corporativo**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Criacao de perfil corporativo".
...
**Explicacao**: Grupo segue AWS_GR_{NOME_DO_PERFIL}_{PRD|HML|DEV}.
**Exemplo**: prf-prd-sre-readonly + AWS_GR_SRE_READONLY_PRD

## 3. Campos da Tela (Criacao de perfil corporativo)
**Objetivo da tela**: Criar perfil corporativo com grupo e PSET associados.
...
- **Nome do Perfil Corporativo (Taxonomia)**: Campo de nomenclatura padronizada para reduzir ambiguidade.
- **Grupo do Perfil de Acesso (Taxonomia)**: Campo de nomenclatura padronizada para reduzir ambiguidade.
- **PSET Associado**: Campo tecnico/operacional necessario para execucao segura.
...
## 7. Exemplos da Tela
- prf-prd-sre-readonly + AWS_GR_SRE_READONLY_PRD
...
- **Nome do Perfil Corporativo (Taxonomia)**
  Tooltip: Informe somente a parte nao padronizada do nome do perfil.
  Exemplo: prf-prd-sre-readonly
  Documentacao AWS: Nao aplicavel

- **Grupo do Perfil de Acesso (Taxonomia)**
  Tooltip: Informe somente a parte variavel do grupo, mantendo padrao de nomenclatura.
