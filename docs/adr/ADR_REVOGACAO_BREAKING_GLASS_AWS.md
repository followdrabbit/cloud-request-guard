...
- Status: Proposto
- Data: 2026-03-18
- Tipo de solicitacao: bg-revoke
- Categoria: Breaking Glass AWS
- Acao registrada: Revogacao de acesso emergencial
...
Foco deste ADR: somente a tela de **Revogacao de acesso emergencial**.
...
**Exemplo**: Esta solicitacao ja nasce no contexto de "Revogacao de acesso emergencial".
...
**Explicacao**: Registrar evidencia objetiva de revogacao.
**Exemplo**: CloudTrail confirma sessao encerrada e privilegio removido

## 3. Campos da Tela (Revogacao de acesso emergencial)
**Objetivo da tela**: Revogar acesso emergencial e registrar evidencia.
...
- **Ticket BG em Andamento**: Campo tecnico/operacional necessario para execucao segura.
- **Evidencia de Revogacao**: Campo tecnico/operacional necessario para execucao segura.
...
## 7. Exemplos da Tela
- CloudTrail confirma sessao encerrada e privilegio removido
...
- **Ticket BG em Andamento**
  Tooltip: Informe o ticket de breaking glass ja existente para ajuste ou revogacao.
  Exemplo: AWS-BG-95001
  Documentacao AWS: Nao aplicavel

- **Evidencia de Revogacao**
  Tooltip: Descreva a evidencia objetiva de revogacao do acesso emergencial.
  Exemplo: CloudTrail confirma sessao encerrada e privilegio removido
  Documentacao AWS: Nao aplicavel
